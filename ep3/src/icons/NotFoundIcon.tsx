...
const NotFoundIcon: FC<SVGProps<SVGSVGElement>> = (props) => {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M512.7 472.2l-43.3 75.1h86.7z" fill="#863A5F" />
      ...
      <path
        d="M512 814.1c-71.7 0-129.9-58.3-129.9-129.9 0-71.7 58.3-129.9 129.9-129.9 71.7 0 129.9 58.3 129.9 129.9 0.1 71.7-58.2 129.9-129.9 129.9z m0-252.7c-67.7 0-122.8 55.1-122.8 122.8 0 67.7 55.1 122.8 122.8 122.8 67.7 0 122.8-55.1 122.8-122.8 0.1-67.7-55-122.8-122.8-122.8z"
        fill="#843A5F"
      />
      <path d="M638.4 684.2c0 69.8-56.6 126.4-126.4 126.4S385.7 754 385.7 684.2" fill="#E6D8DF" />
      <path
        d="M512 814.1c-71.7 0-129.9-58.3-129.9-129.9h7.1c0 67.7 55.1 122.8 122.8 122.8 67.7 0 122.8-55.1 122.8-122.8h7.1c0.1 71.7-58.2 129.9-129.9 129.9z"
        fill="#843A5F"
      />
      <path
        d="M566.2 760H559c0-25.9-21.1-47-47-47s-47 21.1-47 47h-7.1c0-29.8 24.3-54.1 54.1-54.1s54.2 24.3 54.2 54.1z"
        fill="#843A5F"
      />
      <path
        d="M436.2 662.5v-7.1c25.9 0 47-21.1 47-47h7.1c0 29.8-24.3 54.1-54.1 54.1zM587.9 662.5c-29.8 0-54.1-24.3-54.1-54.1h7.1c0 25.9 21.1 47 47 47v7.1z"
        fill="#843A5F"
      />
      <path d="M433.3 894.4l-32.3-56h64.6zM512.7 894.4l-32.3-56H545zM590.8 894.4l-32.4-56h64.7z" fill="#843A5F" />
    </svg>
  );
};
